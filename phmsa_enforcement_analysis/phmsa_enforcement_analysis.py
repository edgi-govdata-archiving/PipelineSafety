...
# Exclude pre-inauguration January days
phmsa_biden = phmsa_biden[~((phmsa_biden["Month"] == 1) & (phmsa_biden["Opened_Date"].dt.day < 20))]
phmsa_trump = phmsa_trump[~((phmsa_trump["Month"] == 1) & (phmsa_trump["Opened_Date"].dt.day < 20))]
